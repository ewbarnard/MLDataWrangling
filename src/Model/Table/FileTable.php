 ...
 * File Model
 *
 * @property \App\Model\Table\DirectoryTable|\Cake\ORM\Association\BelongsTo $Directories
 * @property \App\Model\Table\TrkTable|\Cake\ORM\Association\HasMany $Trk
 *
...
class FileTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn(['directory_id'], 'Directory'));
